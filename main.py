...
class Management:
    def __init__(self, root):
        ...
        self.login_frame = tk.Frame(self.window, bg=cs.color_1)
        self.login_frame.place(x=0, y=0, width=740, relheight=1)

        self.login_frame = tk.Frame(self.window, bg=cs.color_1)
        self.login_frame.place(x=0, y=0, width=740, relheight=1)

        # Add a label for the login screen
        login_label = tk.Label(self.login_frame, text="Login to Library Management System", font=(cs.font_1, 16), bg=cs.color_1, fg=cs.color_3)
        login_label.pack(pady=50)

        self.username_label = tk.Label(self.login_frame, text="Username", font=(cs.font_1, 12), bg=cs.color_1, fg=cs.color_3)
        self.username_label.pack()
        self.username_entry = tk.Entry(self.login_frame, font=(cs.font_1, 12))
        self.username_entry.pack()

        self.password_label = tk.Label(self.login_frame, text="Password", font=(cs.font_1, 12), bg=cs.color_1, fg=cs.color_3)
        self.password_label.pack()
        self.password_entry = tk.Entry(self.login_frame, show="*", font=(cs.font_1, 12))
        self.password_entry.pack()

        login_button = tk.Button(self.login_frame, text="Login", command=self.login, font=(cs.font_1, 12), bg=cs.color_2, fg=cs.color_3)
        login_button.pack()

        self.frame_2 = tk.Frame(self.window, bg=cs.color_2)

        # ... Rest of your code for the main application ...
